<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-sm-5 col-md-4" id="sidebar">
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12 text-center">
                    <ul>
                        ...
                        <li class="mb-3"><a href=""><i class="bi bi-tag icons"></i><span class="menu-text">
        ...
        <div class="col-12 col-sm-7 col-md-8" id="content">
            <div class="row">
